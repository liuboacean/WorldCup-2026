...
const WorldCupApp = (() => {
  ...
  function renderMatchCard(match) {
    ...
    if (match.status === 'notstarted') {
      ...
      scoreHtml = `
        <div class="match-score">${match.homeTeam.score}<span class="score-divider">-</span>${match.awayTeam.score}${match.penalty ? `<span class="match-penalty-below">${match.penalty.home}-${match.penalty.away}</span>` : ''}</div>
